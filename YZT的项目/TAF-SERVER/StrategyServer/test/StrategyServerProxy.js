...
Strategy.StrategyInterfProxy = function () {
    this._name   = undefined;
    this._worker = undefined;
}

Strategy.StrategyInterfProxy.prototype.setTimeout = function (iTimeout) {
    this._worker.timeout = iTimeout;
}

Strategy.StrategyInterfProxy.prototype.getTimeout = function ( ) {
...
Strategy.StrategyInterfProxy.prototype.getChooseStock = function (chooseStockReq) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeStruct(1, chooseStockReq);
        return os.getBinBuffer();
    }
    ...
    var _decode = function (data) {
        try {
            ...
            response.arguments.chooseStockRsp = is.readStruct(2, true, Strategy.ChooseStockRsp);
    ...
    return this._worker.taf_invoke('getChooseStock', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getOptiStock = function () {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        return os.getBinBuffer();
    }
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.optiStockRsp = is.readStruct(1, true, Strategy.OptiStockRsp);
    ...
    return this._worker.taf_invoke('getOptiStock', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getPerfectStock = function () {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        return os.getBinBuffer();
    }
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.topStockRsp = is.readStruct(1, true, Strategy.TopStockRsp);
    ...
    return this._worker.taf_invoke('getPerfectStock', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getStgyInfoList = function (stgyCategory) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeInt32(1, stgyCategory);
        return os.getBinBuffer();
    }
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.stgyInfoRsp = is.readStruct(2, true, Strategy.StgyInfoRsp);
    ...
    return this._worker.taf_invoke('getStgyInfoList', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getStockDiagnosis = function (stReq) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.stRsp = is.readStruct(2, true, Strategy.StockDiagnosisRsp);
    ...
    return this._worker.taf_invoke('getStockDiagnosis', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getStockStar = function (stReq) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeStruct(1, stReq);
        return os.getBinBuffer();
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.stRsp = is.readStruct(2, true, Strategy.StockStarRsp);
    ...
    return this._worker.taf_invoke('getStockStar', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getTopStgyInfoList = function () {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        return os.getBinBuffer();
    }
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.stgyInfoRsp = is.readStruct(1, true, Strategy.StgyInfoRsp);
    ...
    return this._worker.taf_invoke('getTopStgyInfoList', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}

Strategy.StrategyInterfProxy.prototype.getTopStock = function (stgyCode) {
    var _encode = function () { 
        var os = new TafStream.JceOutputStream();
        os.writeString(1, stgyCode);
        return os.getBinBuffer();
    }
    ...
    var _decode = function (data) {
        try {
            ...
            response.costtime = data.request.costtime;
            response.return   = is.readInt32(0, true, TafStream.Int32);
            response.arguments.topStockRsp = is.readStruct(2, true, Strategy.TopStockRsp);
    ...
    return this._worker.taf_invoke('getTopStock', _encode(), arguments.length != 0?arguments[arguments.length - 1]:undefined).then(_decode, _error);
}
